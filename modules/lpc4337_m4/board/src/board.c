...
void Board_Init(void)
{
	...
	Chip_SCU_PinMuxSet(0x2, 6, (SCU_MODE_PULLUP | SCU_MODE_INBUFF_EN | SCU_MODE_FUNC4));
	// P2_5 USB1_VBUS, MUST CONFIGURE THIS SIGNAL FOR USB1 NORMAL OPERATION
	Chip_SCU_PinMuxSet(0x2, 5, (SCU_MODE_INACT | SCU_MODE_INBUFF_EN | SCU_MODE_ZIF_DIS | SCU_MODE_FUNC2));
	// P1_7 USB0_PWR_EN, USB0 VBus function Xplorer
	Chip_SCU_PinMuxSet(0x1, 7, (SCU_MODE_PULLUP | SCU_MODE_INBUFF_EN | SCU_MODE_FUNC4));
	// GPIO5[6] = USB1_PWR_EN
	Chip_GPIO_SetPinDIROutput(LPC_GPIO_PORT, 5, 6);
	// GPIO5[6] output high
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, 5, 6, true);
#endif
