...
TimerHandle_t 	TIMER_5_OBJ;
TimerHandle_t 	TIMER_6_OBJ;
TimerHandle_t 	TIMER_7_OBJ;
TimerHandle_t 	TIMER_8_OBJ;
TimerHandle_t 	TIMER_9_OBJ;
TimerHandle_t 	TIMER_10_OBJ;
...
int timers_create (void)
{
	...
	TIMER_5_OBJ = xTimerCreate( TIMER_5_NAME, TIMER_5_PER, TIMER_5_RELOAD, TIMER_5_IDn, TIMER_5_CALLBACK );
	TIMER_6_OBJ = xTimerCreate( TIMER_6_NAME, TIMER_6_PER, TIMER_6_RELOAD, TIMER_6_IDn, TIMER_6_CALLBACK );
	TIMER_7_OBJ = xTimerCreate( TIMER_7_NAME, TIMER_7_PER, TIMER_7_RELOAD, TIMER_7_IDn, TIMER_7_CALLBACK );
	TIMER_8_OBJ = xTimerCreate( TIMER_8_NAME, TIMER_8_PER, TIMER_8_RELOAD, TIMER_8_IDn, TIMER_8_CALLBACK );
	TIMER_9_OBJ = xTimerCreate( TIMER_9_NAME, TIMER_9_PER, TIMER_9_RELOAD, TIMER_9_IDn, TIMER_9_CALLBACK );
	TIMER_10_OBJ = xTimerCreate( TIMER_10_NAME, TIMER_10_PER, TIMER_10_RELOAD, TIMER_10_IDn, TIMER_10_CALLBACK );

	if( !TIMER_1_OBJ || !TIMER_2_OBJ || !TIMER_3_OBJ || !TIMER_4_OBJ || !TIMER_5_OBJ ||
		!TIMER_6_OBJ || !TIMER_7_OBJ || !TIMER_8_OBJ || !TIMER_9_OBJ || !TIMER_10_OBJ )
	{
		retval |= 1<<6;
	}
